...
export function Navbar() {
  ...
  return (
    <>
      <FluidGlass className="my-3 lg:my-6 w-[calc(100%-40px)] lg:w-4/5 max-w-7xl mx-auto rounded-full pl-0 pr-6">
        <header className="flex items-center justify-between px-4 py-3 relative">
          <button
            onClick={() => setAboutOpen(true)}
            className="font-semibold font-playfair text-lg hover:[&>img]:scale-115 cursor-pointer transition-all flex items-center gap-2 "
          >
            <Image
